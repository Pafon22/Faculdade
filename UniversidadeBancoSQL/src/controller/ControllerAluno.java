...
import view.JFrameAlunoCadastrar;
...
public class ControllerAluno {
     ...
     * @param jFrameAluno
     */
    public ControllerAluno(JFrameAluno jFrameAluno) {
    ...
    public void abrirTelaCadastroAluno(){
        jFrameAluno.hide();
        jFrameAluno.setEnabled(false);
        new JFrameAlunoCadastrar(jFrameAluno).setVisible(true);
    }
    ...
    public void cadastrarAluno(javax.swing.JTextField jTextFieldNome, javax.swing.JTextField jTextFieldCpf) {
        try {
            if (jTextFieldNome.getText().equals("") || jTextFieldCpf.getText().equals("")) {
                ...
                telaAnterior.setEnabled(true);
                 */
                evento.setName("Aluno cadastrado.");
            }
        } catch (Exception e) {
