...
public class Funcionario extends Pessoa {
    ...
    public Funcionario(float salario, float horario, String login, String senha, boolean permissao) {
    ...
    public void preencherFuncionario() {
        ...
        setSalario(getLer().nextFloat());
        System.out.println("Digite a carga horaria: ");
        setHorario(getLer().nextFloat());
        System.out.println("Digite o login: ");
        setLogin(getLer().next());
        while(funcionariobd.jaExisteLogin(login)){
